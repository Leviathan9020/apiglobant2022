...
export class ControladorHabitacion{
    ...
    async insertar(request,response){
        ...
        try{
            await  servicio.registrar(datosPeticion) //Espero a que el s ervicio guarde los datos
    ...
    async buscarPorId(request,response){
        ...
        try{
            ...
            response.status(400).json({
                mensaje:"fallo buscando habitación por id",
                datos:[],
                estado:false
            })
        }     
    ...
    async editar(request,response){
        ...
        try{
            ...
            response.status(400).json({
                mensaje:"fallo editando habitación por id",
                datos:[],
                estado:false
            })
        }  
    ...
    async eliminar(request,response){
        ...
        try{
            ...
            response.status(400).json({
                mensaje:"fallo eliminando habitación por id",
                datos:"Datos del id: "+id,
                estado:false
            })
        }
